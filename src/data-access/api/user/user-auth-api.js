...
export const postUserRegistrationData = createAsyncThunk(
    ...
    async (FormUserData, thunkAPI) => {
        try{
            let userdata = await axios.post("https://hirehands-backend.onrender.com/auth/usersignup", FormUserData);
...
export const postUserLoginData = createAsyncThunk(
    ...
    async (FormUserData, thunkAPI) => {
        try {
            let  data  = await axios.post("https://hirehands-backend.onrender.com/auth/usersignin", FormUserData);
